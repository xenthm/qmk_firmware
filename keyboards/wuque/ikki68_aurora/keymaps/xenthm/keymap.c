...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT_all(
        ...
        _______, KC_HOME, KC_UP  , KC_END , _______, _______, _______, KC_HOME, KC_UP  , KC_END , KC_PGUP, KC_PGDN, KC_SCRL, KC_PSCR,             _______, KC_END ,
    ...
    LAYOUT_all(
        ...
        _______, RGB_TOG,RGB_RMOD, RGB_MOD, _______, _______, _______, _______, _______, _______, _______, _______, _______, QK_BOOT,             _______, _______,
...
const rgblight_segment_t PROGMEM winlock_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {9, 1, HSV_RED}
);
...
bool led_update_user(led_t led_state) {
    rgblight_set_layer_state(0, IS_LAYER_ON(1));
    return true;
}